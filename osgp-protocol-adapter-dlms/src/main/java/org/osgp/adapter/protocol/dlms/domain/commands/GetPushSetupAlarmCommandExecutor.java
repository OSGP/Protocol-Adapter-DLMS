...
@Component()
public class GetPushSetupAlarmCommandExecutor extends GetPushSetupCommandExecutor<PushSetupAlarmDto> {
    ...
    @Override
    public PushSetupAlarmDto execute(final ClientConnection conn, final DlmsDevice device)
